  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="main-navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li><a href="<?=site_url('../smarthome/index.php')?>" target="_blank"><abbr title="Final Year Project">FYP</abbr><span class="glyphicon glyphicon-new-window nav-icon" aria-hidden="true"></span></a></li>
        ...
        <li><a href="https://www.dropbox.com/sh/q6s49e8y1jlo34c/AAA0Zel0QOPvI7gGLqqKCdCja?dl=0" target="_blank">Game Ideas &amp; Concepts (Drafts)<span class="glyphicon glyphicon-new-window nav-icon" aria-hidden="true"></span></a></li>
